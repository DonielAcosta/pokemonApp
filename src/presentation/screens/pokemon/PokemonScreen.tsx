  ...
  return (
    <ScrollView
      ...
      <View
        ...
        {pokemon.types.map(type => (
          <Chip
            ...
            style={{
              marginLeft: 10,
              backgroundColor: 'rgba(0,0,0,0.3)', // o un color específico por tipo
            }}>
            {type}
          </Chip>
        ))}
      ...
      <FlatList
        ...
        showsHorizontalScrollIndicator={false}
        renderItem={({item})=>{
          return <Chip selectedColor="white">{Formatter.capitalize(item)}</Chip>;
        }}
      />
      {/* Stats */}
